...
search_paths: dict[str, list[str]] = {
    ...
    resource_id(ResourceKind.controlnet, Arch.sdxl, ControlMode.scribble): ["controlnet-union-sdxl", "xinsirscribble", "scribble-sdxl", "mistoline_fp16", "mistoline_rank", "control-lora-sketch-rank", "sai_xl_sketch_"],
    ...
    resource_id(ResourceKind.controlnet, Arch.sdxl, ControlMode.line_art): ["controlnet-union-sdxl", "xinsirscribble", "mistoline_fp16", "mistoline_rank", "scribble-sdxl", "control-lora-sketch-rank", "sai_xl_sketch_"],
    ...
    resource_id(ResourceKind.controlnet, Arch.sdxl, ControlMode.canny_edge): ["controlnet-union-sdx", "xinsircanny", "canny-sdxl" "control-lora-canny-rank", "sai_xl_canny_"],
    ...
    resource_id(ResourceKind.controlnet, Arch.sdxl, ControlMode.depth): ["controlnet-union-sdxl", "xinsirdepth", "depth-sdxl", "control-lora-depth-rank", "sai_xl_depth_"],
    ...
    resource_id(ResourceKind.controlnet, Arch.sdxl, ControlMode.pose): ["controlnet-union-sdxl", "xinsiropenpose", "openpose-sdxl", "control-lora-openposexl2-rank", "thibaud_xl_openpose"],
